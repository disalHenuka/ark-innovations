...
export const metadata: Metadata = {
  ...
  keywords: [
    "Ark Innovations", "Ark Innovations Pvt Ltd", "Recruitment Sri Lanka", 
    "Manpower Supply", "Outsourcing Services", "Executive Search", 
    "Jobs in Panadura", "Recruitment Agency Colombo", "HR Solutions Western Province", 
    "Manpower Agency Moratuwa", "Employment Wadduwa", "Talent Acquisition Kalutara"
  ],
